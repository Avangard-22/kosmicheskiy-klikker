...
const CONFIG = {
    ...
    scale: 1.0,                    // База для всех планет
    masterAU: 0.38710,             // Реальное значение AU Меркурия
...
console.log('☿ [ACH-V2] Mercury config loaded. Metrics:', Object.keys(CONFIG.metrics).length);
})();