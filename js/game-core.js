    ...
    window.GAME_CORE = {
        ...
        destroyBlock: function(block, isAuto = false) {
            ...
            if (window.CombatSystem) {
                ...
                console.error('[CORE] CombatSystem missing in destroyBlock!');
            ...
            if (rewardResult.comboCount > 1 && !isAuto) {
                this.showComboText(rewardResult.comboCount, rewardResult.comboBonus, block);
                this.playSound('comboSound');
            }
            
            this.showRewardText(rewardResult.reward, block);
            ...
            setTimeout(() => { 
                if (window.gameState?.gameActive) this.createMovingBlock(); 
            }, 500);
        },
        ...
        showRewardText: function(r, block) {
            if (UI.showRewardText) {
                UI.showRewardText(r, block);
                return;
            }
        ...
        createHelperElement: function() {
            ...
            setTimeout(() => { 
                if (this.helperElement) this.helperElement.style.opacity = '1'; 
            }, 100);
        },
        ...
        continueGame: async function() {
            ...
            if (!window.gameState || Object.keys(window.gameState).length === 0) {
                window.gameState = {
                    ...
                    helperUpgradeLevel: 0, helperActivations: 0, helperActive: false,
                    helperTimeLeft: 0, helperDamageBonus: 0, boboCoinBonus: 0,
                    comboCount: 0, lastDestroyTime: 0, gameActive: false, gamePaused: false,
                    achievements: {}, shopItems: {}, permanentBonuses: {},
